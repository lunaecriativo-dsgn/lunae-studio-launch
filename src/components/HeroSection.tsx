              ...
              <div className="flex justify-center">
                <button
                  ...
                  onMouseEnter={(e) => {
                    ...
                    e.currentTarget.style.backgroundColor = '#FF879A';
                    e.currentTarget.style.boxShadow = '0 8px 30px -4px rgba(255, 135, 154, 0.5)';
                  }}
                  onMouseLeave={(e) => {
                    e.currentTarget.style.transform = 'translateY(0)';
                    e.currentTarget.style.backgroundColor = '#443A94';
