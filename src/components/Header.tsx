            ...
            {navItems.map((item) => (
              <li key={item.href}>
                <a
                  ...
                  className="font-body font-medium text-primary-foreground/85 hover:text-secondary transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-accent rounded-lg px-3 py-2 min-h-[44px] inline-flex items-center text-[16px]"
                >
                  {item.label}
                </a>
              </li>
              ...
              {navItems.map((item) => (
                <li key={item.href}>
                  <a
                    href={item.href}
                    onClick={(e) => handleNavClick(e, item.href)}
                    className="block font-body font-medium text-primary-foreground/85 hover:text-secondary transition-colors duration-200 py-3 px-2 min-h-[44px] focus:outline-none focus:ring-2 focus:ring-accent rounded-lg"
                  >
                    {item.label}
                  </a>
                </li>
